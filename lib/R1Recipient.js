...
import {wordPad, numberPad, fillWith} from './utils/index.js';

/**
 * @typedef {import('./indicativeArea/RecipientIndicativeArea.js').default} RecipientIndicativeArea
 * @typedef {import('./address/RecipientAddress.js').default} RecipientAddress
 */
...
class R1Recipient {
   ...
   * @param  {String} [blocks.recipient.siret]           R 112 SIRET bénéficiaire
