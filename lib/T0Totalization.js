import {numberPad, wordPad, fillWith} from './utils/index.js';

/**
 * @typedef {import('./RCM.js').default} RCM
 */
...
class T0Totalization {
  ...
  export() {
    ...
    return [
      ...
      wordPad(this.rcm.d0.issuerIndicativeArea.common.data.siret.substring(0, 9), 9),
      // T014 reserved, filled with spaces
      fillWith(' ', 588)
    ];
  }
}
